...
class ChatConversation(UUIDModel):
    ...
    participants = models.ManyToManyField('Auth.CustomUser', related_name='conversations')
...
class ChatMessage(UUIDModel):
    ...
    sender = models.ForeignKey('Auth.CustomUser', on_delete=models.CASCADE, related_name='sent_messages')
