...
class EmergencySOS(UUIDModel):
    ...
    user = models.ForeignKey('Auth.CustomUser', on_delete=models.CASCADE, related_name='sos_alerts', help_text='User who triggered the SOS')
    ...
    acknowledged_by = models.ForeignKey('Auth.CustomUser', on_delete=models.SET_NULL, null=True, blank=True, related_name='acknowledged_sos', help_text='Admin who acknowledged the SOS')
